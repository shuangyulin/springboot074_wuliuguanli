<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作项目" prop="gongzuoxiangmu">
          <el-input v-model="ruleForm.gongzuoxiangmu" 
              placeholder="工作项目" clearable  :readonly="ro.gongzuoxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作项目" prop="gongzuoxiangmu">
              <el-input v-model="ruleForm.gongzuoxiangmu" 
                placeholder="工作项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="完成状况" prop="wanchengzhuangkuang">
          <el-select v-model="ruleForm.wanchengzhuangkuang" placeholder="请选择完成状况">
            <el-option
                v-for="(item,index) in wanchengzhuangkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="完成状况" prop="wanchengzhuangkuang">
	      <el-input v-model="ruleForm.wanchengzhuangkuang"
                placeholder="完成状况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="待解决问题" prop="daijiejuewenti">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="待解决问题"
                  v-model="ruleForm.daijiejuewenti" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.daijiejuewenti" label="待解决问题" prop="daijiejuewenti">
                    <span>{{ruleForm.daijiejuewenti}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="工作总结" prop="gongzuozongjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="工作总结"
                  v-model="ruleForm.gongzuozongjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuozongjie" label="工作总结" prop="gongzuozongjie">
                    <span>{{ruleForm.gongzuozongjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	gongzuoxiangmu : false,
	gongzuoneirong : false,
	wanchengzhuangkuang : false,
	daijiejuewenti : false,
	gongzuozongjie : false,
	beizhu : false,
	riqi : false,
	sfsh : false,
	shhf : false,
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mendianmingcheng = true;
          ...
          if(o=='gongzuoxiangmu'){
            this.ruleForm.gongzuoxiangmu = obj[o];
	    this.ro.gongzuoxiangmu = true;
            continue;
          }
          if(o=='gongzuoneirong'){
	    ...
	    this.ro.gongzuoneirong = true;
          ...
          if(o=='wanchengzhuangkuang'){
            this.ruleForm.wanchengzhuangkuang = obj[o];
	    this.ro.wanchengzhuangkuang = true;
            continue;
          }
          if(o=='daijiejuewenti'){
            this.ruleForm.daijiejuewenti = obj[o];
	    this.ro.daijiejuewenti = true;
            continue;
          }
          if(o=='gongzuozongjie'){
            this.ruleForm.gongzuozongjie = obj[o];
	    this.ro.gongzuozongjie = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
		...
		if(json.bumen!=''&&json.bumen){
          ...
          this.$message.error(data.msg);
            ...
            this.wanchengzhuangkuangOptions = "已完成,未完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
